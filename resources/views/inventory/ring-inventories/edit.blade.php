        ...
        <form method="POST" action="{{ route('ring-inventories.update', $ringInventory) }}" class="space-y-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <label class="block">
                    ...
                    <input type="number" name="sold_quantity" min="0" value="{{ old('sold_quantity', $ringInventory->sold_quantity) }}" class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none ring-brand-200 focus:ring-4"/>
                </label>
                <label class="block">
