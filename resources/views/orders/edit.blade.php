        ...
        <form method="POST" action="{{ route('orders.update', $order) }}" class="space-y-6" id="orderForm">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <label class="block">
                    ...
                    <input type="text" name="invoice_number" value="{{ old('invoice_number', $order->invoice_number) }}" required class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none ring-brand-200 focus:ring-4"/>
                </label>
