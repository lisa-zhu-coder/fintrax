                ...
                <div class="rounded-xl border-2 border-brand-100 bg-brand-50/30 p-4 ring-1 ring-brand-100">
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                        ...
                        <label class="block">
                            ...
                            <input type="number" name="cash_expenses" id="cashExpenses" step="0.01" min="0" value="{{ old('cash_expenses', 0) }}" readonly class="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm outline-none ring-brand-200 focus:ring-4"/>
